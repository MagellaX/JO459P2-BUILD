    ...
    <div class="card shadow-sm task__card">
      ...
      <div class="card-body">
        ${url
          ...
          : `<img width='100%' src="https://imageio.forbes.com/specials-images/imageserve/64f82da1500f5435a772ce0e/FRANCE-TECHNOLOGY-IT-VIVATECH/0x0.jpg?format=jpg&crop=5482,3081,x0,y0,safe&width=1440" alt='Card Image' class='card-img-top md-3 rounded-lg' />`
        }
...
const saveEdit = (e) => {
  ...
  const saveEdit = (e) => {
    ...
    let stateCopy = [...state.taskList]; // Using spread operator to create a shallow copy
    ...
    submitButton.innerHTML = "Open Task"; // Change the button text to "Open Task"
    submitButton.removeEventListener("click", saveEdit); // Remove the click event listener for saving edits
    submitButton.addEventListener("click", openTask); // Add the click event listener for opening task
